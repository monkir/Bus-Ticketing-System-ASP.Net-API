...
export default function App() {
    ...
    return (
        <>
            <CustomerHeader title="Bus Ticketing System" pagename="customer: Manage Bus Provider"/>
                    ...
                    <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                        <div className='bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full'>
                            ...
                            <div class="grid grid-flow-col justify-stretch space-x-2 mx-2">
                                <Link className='btn btn-info' href={'/customer'}>Back to Panel</Link>
                                <Link className='btn btn-warning' href={'/customer/profile/changepassword'}>Change Password</Link>
                            </div>
                        </div>
                    </div>
                </div>
