...
export default function Example() {
    ...
    async function fetchData(searchValue = "") {
        try {
            ...
            //         process.env.NEXT_PUBLIC_api_root + '/api/employee/ticket/search/' + searchValue,
            //         {
    ...
    return (
        <>
            <EmployeeHeader title="Bus Ticketing System" pagename="employee: My tickets" />
            ...
            <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
                <div className=" mx-auto space-x-2">
                    ...
                    <Link className="btn btn-primary" href={'/employee/account/deposit'}>Depostit</Link>
                    <Link className="btn btn-secondary" href={'/employee/account/withdraw'}>Withdraw</Link>
                </div>
            </div>
