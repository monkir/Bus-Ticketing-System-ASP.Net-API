...
export default function Example() {
    ...
    return (
        <>
            <CustomerHeader title="Bus Ticketing System" pagename="Customer: My Account" />
            ...
            <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
                <div className=" mx-auto space-x-2">
                    ...
                    <Link className="btn btn-primary" href={'/customer/account/deposit'}>Depostit</Link>
                    <Link className="btn btn-secondary" href={'/customer/account/withdraw'}>Withdraw</Link>
                </div>
            </div>
