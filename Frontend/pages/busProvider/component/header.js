        ...
        <>
            ...
            <div className="navbar bg-base-100">
                ...
                <div className="navbar-end">
                    <Link className="btn btn-ghost normal-case text-xl" href={"/busProvider/account"}>My Account</Link>
                    <Link className="btn btn-ghost normal-case text-xl" href={"/busProvider/profile"}>My Profile</Link>
