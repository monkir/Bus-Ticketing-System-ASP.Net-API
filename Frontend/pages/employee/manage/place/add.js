...
export default function App() {
    ...
    const onSubmit = async data => {
        ...
        try {
            const response = await axios.post(
                process.env.NEXT_PUBLIC_api_root + '/api/employee/place/add',
                content,
                {
    ...
    return (
        <>
            ...
            <EmployeeHeader title="Bus Ticketing System" pagename="Employee: Add Place"></EmployeeHeader>
            ...
            <dialog id="my_modal_1" className="modal" onClose={() => { router.push('/employee/manage/place') }}>
                ...
                <div className="modal-box">
                    ...
                    <p className="py-4">New place is created successfully</p>
