        ...
        <>
            ...
            <div className="navbar bg-base-100">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                            <li><Link href={"/employee/profile"}>My Profile</Link></li>
                            <li><Link href={"/employee/account"}>My Account</Link></li>
                ...
                <div className="navbar-center">
                    ...
                    <Link className="btn btn-ghost normal-case text-xl" href={"/employee/manage/place"}>Manage place</Link>
                    <Link className="btn btn-ghost normal-case text-xl" href={"/employee/manage/trip"}>Manage Trip</Link>
                </div>
                <div className="navbar-end">
                    <Link className="btn btn-ghost normal-case text-xl" href={"/employee/account"}>My Account</Link>
                    <Link className="btn btn-ghost normal-case text-xl" href={"/employee/profile"}>My Profile</Link>
